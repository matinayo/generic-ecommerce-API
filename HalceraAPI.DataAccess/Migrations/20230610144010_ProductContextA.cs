...
{
    /// <inheritdoc />
    public partial class ProductContextA : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseAddresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BaseAddresses_ApplicationUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCart_ApplicationUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompositionData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompositionData_Compositions_CompositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseAddresses_ApplicationUserId",
                table: "BaseAddresses",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CompositionData_CompositionId",
